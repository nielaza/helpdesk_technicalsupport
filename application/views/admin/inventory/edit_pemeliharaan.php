...
<div class="container-fluid">
    <h5 class="h5 mb-0 text-gray-800">Edit Pemeliharaan Inventory</h5><hr>
</div>
<!-- /.container-fluid -->
...
<div class="container-fluid">
	<div class="card">
		<div class="card-body">
			<form method="POST" action="<?php echo base_url('admin/inventory/pemeliharaan-update')?>">
                <div class="row clearfix">
                    <div class="col-sm-6 form-group">
                        <label><strong>Barcode</strong></label>
                        <input type="hidden" name="id" value="<?php echo $data_pemeliharaan[0]->id; ?>">
                ...
                <div class="row clearfix">
                    <div class="col-sm-12 form-group">
                        ...
                        <textarea name="keterangan" class="form-control" placeholder="Masukkan Keterangan .." cols="45" rows="5" required><?php echo $data_pemeliharaan[0]->keterangan ?></textarea>
                    </div>
                </div>
